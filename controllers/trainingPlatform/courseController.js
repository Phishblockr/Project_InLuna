    ...
    videos: [
      {
        ...
        description:
          "This video provides an introduction to JavaScript and its basics.",
        resources: [
          {
            url: "https://example.com/docs/js-basics.pdf",
            text: "JavaScript Basics PDF",
          },
          {
            url: "https://example.com/slides/js-intro-slides.ppt",
      ...
      },
      {
        ...
        resources: [
          {
            url: "https://example.com/docs/js-functions.pdf",
    ...
    videos: [
      {
        ...
        description:
          "Learn about lists, dictionaries, and other data structures in Python.",
        resources: [
          {
            url: "https://example.com/docs/python-data-structures.pdf",
            text: "Python Data Structures Guide",
          },
        ],
        assignEmail: true,
      },
      {
        ...
        description:
          "Understand the concepts of OOP and how to apply them in Python.",
        resources: [],
        assignEmail: false,
      },
    ],
