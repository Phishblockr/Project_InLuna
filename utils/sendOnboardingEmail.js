...
export const sendOnboardingEmail = async (to, subject, content, user) => {
    const msg = {
        to,
  ...
  <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; font-size: 18px; color: #333; background-color: #eeeeee;">
    ...
    <div style="padding: 10px; width: 100%;">
      <p>Hi ${user.name}</p>
      <p>We are very excited to have you onboard. Here is your organization ID—please keep it safe: <span>${content}</span></p>
      <p>And here is your username: <span>${user.username}</span></p>
      <p>Get started with setting up your environment on <a href="https://dashboard.theinluna.com" style="color: #0364BD; text-decoration: underline;">Dashboard</a></p>
