...
const CreateModal = ({ isOpen, onClose, onCreated }) => {
    ...
    const changeQuestionType = (qIdx, type) => {
        setForm((f) => {
            ...
            if (type === "true-false") {
                ...
                const prev =
                    q.options && q.options[0] ? q.options[0].correct : false;
                q.options = [
                    { text: "True", media: "", correct: prev === true },
                    {
                        text: "False",
                        media: "",
                        correct: prev === false ? true : false,
                    },
                ];
    ...
    return (
        ...
        >
            ...
            {/* Minimal scrollbar styles scoped to this modal */}
            <style>{`
        /* Firefox */
        #create-modal { scrollbar-width: thin; scrollbar-color: rgba(255,255,255,0.12) transparent; }
        :root .dark #create-modal { scrollbar-color: rgba(255,255,255,0.18) transparent; }

        /* WebKit */
        #create-modal::-webkit-scrollbar { width: 10px; height: 10px; }
        #create-modal::-webkit-scrollbar-track { background: transparent; }
        #create-modal::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.12); border-radius: 9999px; border: 2px solid transparent; background-clip: padding-box; }
        :root .dark #create-modal::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.12); }

        /* smaller inner scrollbars */
        #create-modal .space-y-4, #create-modal .space-y-2 { scrollbar-width: thin; }
      `}</style>
