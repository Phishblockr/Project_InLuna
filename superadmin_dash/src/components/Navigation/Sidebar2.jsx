...
const Sidebar2 = ({ expanded, setExpanded }) => {
    ...
    const activeLinkStyle =
        "py-5 px-3 w-full rounded-lg shadow bg-[#0364BD] text-[#f4f4f4] transition";
    const inactiveLinkStyle =
        "py-5 px-3 w-full rounded-lg hover:shadow hover:bg-gray-100 dark:hover:bg-[#00285A] transition";
    ...
    return (
        <nav
            className={`h-full flex flex-col bg-white shadow-sm transition-all dark:bg-[#002451] ${
                expanded ? "w-61" : "w-20"
            }`}
        >
            <div className="p-4 pb-2 flex justify-between items-center">
                ...
                <h1
                    className={`text-2xl text-left text-black font-medium tracking-tighter dark:text-[#F4F4F4] overflow-hidden transition-all ${
                        expanded ? "w-52" : "w-0"
                    }`}
                >
                ...
                <button
                    ...
                    className="p-1 5 rounded-lg hover:bg-gray-100 dark:text-[#F4F4F4] dark:bg- dark:hover:bg-[#00285A]"
                >
