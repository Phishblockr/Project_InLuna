...
export default function AddCampaign() {
    ...
    // Combine date and time into a standard date-time format
    const getDateTimeString = (date, time) => {
        return `${date}T${time}:00`; // Combine date and time in ISO 8601 format
    };
    ...
    const handleSubmit = (e) => {
        ...
        if (
            ...
            const newCampaign = {
                ...
                startDate: getDateTimeString(formData.startDate, formData.startTime),
                endDate: getDateTimeString(formData.endDate, formData.endTime),
            };
