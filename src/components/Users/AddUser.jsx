...
const AddUser = () => {
    ...
    const textBarStyle =
        "w-full p-2 rounded-t-lg border-b-2 border-dashed bg-gray-100 border-gray-500 focus:outline-none focus:ring-2 focus:ring-[#0364BD] dark:bg-[#001C40] dark:border-0";
    ...
    async function fetchRoles() {
        const res = await fetch(`${apiUrl}/meta/roles`);
